               ...
               <div class="flex">
                   <div class="w-1/3 flex flex-col ">
                       <ul role="list" class="divide-y divide-gray-200 w-full">
                           ...
                           <li class="py-4 px-8" >
                               <button @click="select(exp)" class="border-l-4 border-teal-500 hover:bg-gray-100 py-2 px-4 w-full" x-text="exp.name"></button>
                           </li>
                           </template>
                       </ul>
                   </div>
    ...
    function data() {
        return {
            ...
            renderChart() {
                ...
                const goals = this.current.conditions.reduce((acc, row) => acc + row.goals, 0);
                const data = [
...
current: {!! json_encode($experiments[0]) !!},
            @else
current: null
            @endif
}
